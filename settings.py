...
# digest email logos
NOTIFICATION_OPEN_EDX_DEFAULT_LOGO = BASE_DIR + '/edx-notifications/edx_notifications/server/web/static/edx_notifications/img/edx-openedx-logo-tag.png'

NOTIFICATION_BRANDED_DEFAULT_LOGO = BASE_DIR + '/edx-notifications/edx_notifications/server/web/static/edx_notifications/img/logo-placeholder.png'
