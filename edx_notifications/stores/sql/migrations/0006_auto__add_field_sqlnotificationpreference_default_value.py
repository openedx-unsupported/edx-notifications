...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SQLNotificationPreference.default_value'
        db.add_column('edx_notifications_notificationpreference', 'default_value',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SQLNotificationPreference.default_value'
        db.delete_column('edx_notifications_notificationpreference', 'default_value')
