...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SQLNotificationType.renderer_context'
        db.add_column('edx_notifications_notificationtype', 'renderer_context',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SQLNotificationType.renderer_context'
        db.delete_column('edx_notifications_notificationtype', 'renderer_context')
