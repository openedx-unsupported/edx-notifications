...
PURGE_READ_NOTIFICATIONS_OLDER_THAN_DAYS = getattr(settings, 'PURGE_READ_NOTIFICATIONS_OLDER_THAN_DAYS', None)
PURGE_UNREAD_NOTIFICATIONS_OLDER_THAN_DAYS = getattr(settings, 'PURGE_UNREAD_NOTIFICATIONS_OLDER_THAN_DAYS', None)
